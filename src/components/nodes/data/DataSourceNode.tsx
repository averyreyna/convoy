...
import { button, input, spinnerLg, dropZoneDefault, dropZoneActive, tableContainer, tableHeader } from '@/flank';
...
interface DataSourceUploadSectionProps {
  isDragOver: boolean;
  isParsing: boolean;
  ...
  onUrlSubmit: () => void;
  onLoadSample: (sample: (typeof SAMPLE_DATASETS)[number]) => void;
  fileInputRef: React.RefObject<HTMLInputElement>;
}

interface DataSourceLoadedSectionProps {
  data: DataSourceNodeData;
  previewRows: DataFrame['rows'];
  displayColumns: Column[];
  onClearFile: () => void;
}

function DataSourceUploadSection({
  isDragOver,
  isParsing,
  parseError,
  showUrlInput,
...
function DataSourceLoadedSection({
  data,
  previewRows,
  displayColumns,
  onClearFile,
}: DataSourceLoadedSectionProps) {
  return (
    <div className="space-y-2">
      {/* File info header */}
